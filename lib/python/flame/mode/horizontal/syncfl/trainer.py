...
class Trainer(Role, metaclass=ABCMeta):
    ...
    def _send_weights(self, tag: str) -> None:
        ...
        logger.info(f"msg {msg}, self.trainer_id: {self.trainer_id}")
    ...
    def sleep(self, tag: str) -> None:
        ...
        print(f"### before trainer sleep tag check")
        if tag == TAG_SLEEP:
            print(f"### trainer sleep tag was found")
            self._sleep_trainer(tag)

    def _sleep_trainer(self, tag: str) -> None:
        logger.info(f"### send _sleep_trainer msg for tag: {tag} and trainer_id: {self.trainer_id}")
    ...
    def wake(self, tag: str) -> None:
        ...
        print(f"### in trainer wake tag check")
        if tag == TAG_WAKE:
            print(f"### trainer wake tag was found")
            self._wake_trainer(tag)

    def _wake_trainer(self, tag: str) -> None:
        logger.info(f"### send _wake_trainer msg for tag: {tag} and trainer_id: {self.trainer_id}")
