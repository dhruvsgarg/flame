...
for baseline_name in "${baseline_names[@]}"; do
  ...
  for alpha in "${alphas[@]}"; do
    ...
    python pytorch/main.py expt_cifar_27oct24_iAgg_iSel_clientNotify_evalGoal3_c30_k10.json --log_to_wandb --wandb_run_name agg_${node_name}_$(date +%d_%m_%H_%M)_alpha${alpha}_cifar_70acc_${aggType}_${selType}_${awareType}_battery50_evalGoal3_c30_k10 > "$agg_log_file" 2>&1 &
