...
availability_traces=("syn_0" "syn_20")
...
for trace in "${availability_traces[@]}"; do
  ...
  config_file="/Users/seshutummala/CodeRepo/OMSCS//flame/lib/python/examples/async_cifar10/eurosys26_expts/configs/felix_abl_n300_13may25_evalGoal1.5_noTierFuse.json"
