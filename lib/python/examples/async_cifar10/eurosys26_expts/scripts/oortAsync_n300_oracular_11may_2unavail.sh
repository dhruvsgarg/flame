...
for trace in "${availability_traces[@]}"; do
  ...
  config_file="/Users/seshutummala/CodeRepo/OMSCS//flame/lib/python/examples/async_cifar10/eurosys26_expts/configs/oortAsync_n300_oracular_9may25_${trace}.json"
