...
for baseline_name in "${baseline_names[@]}"; do
  ...
  for alpha in "${alphas[@]}"; do
    ...
    python pytorch/main_oort_agg.py oort_config_large_expt_oracular_9feb25_syn_0fail.json --log_to_wandb --wandb_run_name agg_${node_name}_$(date +%d_%m_%H_%M)_alpha${alpha}_cifar_70acc_${aggType}_${selType}_${awareType}_c13_1.3k > "$agg_log_file" 2>&1 &
    agg_pid=$!
