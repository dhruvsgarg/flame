...
class PyTorchCifar10Aggregator(OracleInjectMixin, TopAggregator):
    ...
    def evaluate(self) -> None:
        ...
        # pass in a daemon thread so the aggregator keeps progressing. Cross-
        # reference (§11/§6 Parts 5-6, fwdllm's simulate_fwdllm.md §G):
        # this backgrounding is why this example needs no sim_model_*_compute_time
        # -style vclock fold (flame/config.py) — see main_asyncfl_agg.py's
        # evaluate() for the full reasoning.
