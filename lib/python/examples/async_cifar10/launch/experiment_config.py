...
class AvailabilityConfig:
    ...
    mode: str = "mobiperf_2st"  # mobiperf_2st, mobiperf_3st_50, mobiperf_3st_75, syn_0, syn_20, syn_50
        ...
        for exp_data in data.get('experiments', []):
            ...
            exp = ExperimentConfig(
                ...
                trainer=TrainerConfig(
                    ...
                    availability=AvailabilityConfig(**avail_data) if avail_data else AvailabilityConfig(),
                ...
                execution=ExecutionConfig(**exec_data) if exec_data else ExecutionConfig(),
            )
