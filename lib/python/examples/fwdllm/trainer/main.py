...
if __name__ == "__main__":
    ...
    train_data_local_dict, test_data_local_dict, num_clients = dm.load_federated_data(process_id=process_id, client_idx=args.client_idx)
    logging.info(f"NRL Client idx: {args.client_idx}")
