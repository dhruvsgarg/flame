...
"""HIRE_MNIST horizontal hierarchical FL middle level EAGER aggregator for Pytorch."""
...
from flame.mode.horizontal.eager_syncfl.middle_aggregator import MiddleAggregator
