...
"""HIRE_MNIST horizontal hierarchical FL top level EAGER aggregator
for Pytorch."""
...
from flame.mode.horizontal.eager_syncfl.top_aggregator import TopAggregator
...
class PyTorchMnistTopAggregator(TopAggregator):
    ...
    def load_data(self) -> None:
        ...
        # choose 1000 samples out of 10000 test samples to keep
